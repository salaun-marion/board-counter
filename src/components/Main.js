...
export default function Main() {
  ...
  const tinypanels = [
    ...
    },
    {
      title: 'RBAC',
      description:
        'Role Based Access Control for both user interface actions and API endpoints.',
      pro_off_on: 'on',
      counter: 0,
    },
    {
      ...
      description:
        'Use board to store one time passwords and easily share them securely with team members.',
      pro_off_on: 'on',
      counter: 0,
    },
    {
      title: 'Advanced Audit logs',
      description: 'More options to see who is doing what on board.',
      pro_off_on: 'on',
      counter: 0,
    },
    {
    ...
    },
    {
      ...
      description:
        'Users who lost their passphrase or private key can recover their account.',
      pro_off_on: 'on',
      counter: 0,
    },
    {
      title: 'Forms auto-save',
      description: 'Board remembers passwords from web pages.',
      pro_off_on: 'on',
      counter: 0,
    },
    {
    ...
    },
    {
      ...
      description:
        'The interface and documentation are translatable in mutliple languages.',
      pro_off_on: 'on',
      counter: 0,
    },
  ];
      ...
      {backpanels.map((backpanel) => {
        return (
          <BackPanel
            ...
            card={tinypanels
              .slice(backpanel.start, backpanel.end)
              .map((tinypanel) => {
                return (
                  <Tinypanel
                    key={uuidv4()}
